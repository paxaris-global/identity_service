...
public class DockerBuildService {
    ...
    public boolean buildDockerImage(Path sourceCodePath, String imageName) {
        log.info("Building Docker image: {} from path: {}", imageName, sourceCodePath);
        ...
        try {
            ...
            log.error("Error building Docker image {}: {}", imageName, e.getMessage(), e);
    ...
    public boolean pushDockerImage(String imageName) {
        ...
        try {
            ...
            throw new RuntimeException("Failed to push Docker image: " + e.getMessage(), e);
        }
    }
     ...
     */
    private void generateDefaultDockerfile(Path dockerfilePath) throws IOException {
